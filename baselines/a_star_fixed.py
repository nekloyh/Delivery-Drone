# baselines/a_star_fixed.py
import argparse, json
from a_star_baseline import run_a_star_episodes  # assume your repo has this
...
ap.add_argument("--log", default="out/a_star_fixed.parquet")
args=ap.parse_args()
...
df = run_a_star_episodes(args.airsim_ip, args.airsim_port, starts, goals,
                         dt=args.dt, vxy=args.vxy_max, vz=args.vz_max, yawrate=args.yawrate_max)
